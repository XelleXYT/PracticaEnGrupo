...
public class VentaPrincipal extends javax.swing.JFrame {
	...
	//ClaseMarta
	try {
	    ClaseMarta clase = new ClaseMarta();
	    if (clase.caughtSpeeding(60, false) == 0 && clase.caughtSpeeding(65, false) == 1 && clase.caughtSpeeding(65, true) == 0) {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Marta");

        jLabel2.setText("Jose");

        jLabel3.setText("Alejandro");

        jLabel4.setText("Daniel");

        jLabel5.setText("Gonzalo");

        jLabel6.setText("Roman");
	...
	try {
	    ...
	    java.util.logging.Logger.getLogger(VentaPrincipal.class
